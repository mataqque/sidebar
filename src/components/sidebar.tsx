      ...
      { id: "children", node: children },
      {
        ...
        node:
          items && items.length > 0 ? (
            <SidebarMenu items={items} label={menuLabel} onSelect={onSelect} />
          ) : undefined,
      },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          aria-hidden
          className="pointer-events-none absolute inset-y-0 right-0 z-10 w-px bg-[var(--sb-border)]"
        />
        {sections.map((section, index) => {
          const hasSeparator =
            index > 0 && (section.id === "menu" || section.id === "footer");
          return (
